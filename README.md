...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/withered-paper-3015
```

A live public deployment of this template is available at [https://withered-paper-3015.templates.workers.dev](https://withered-paper-3015.templates.workers.dev)
